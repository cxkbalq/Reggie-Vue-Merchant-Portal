  ...
  <div id="main" class="app">
      ...
      <div class="divStatic">
        ...
        <div class="divDesc">
          ...
          <div class="divSend">
            ...
            <span><img src="@/images/front/location.png"/> 预计时长12min</span>
          </div>
        </div>
      </div>
      <div class="divDesc">
            ...
            <div>
              ...
              <div class="divNum">
                <div class="divSubtract" v-if="item.number > 0">
                  <img src="@/images/front/subtract.png" @click.prevent.stop="subtractCart(item)"/>
                </div>
                ...
                <div class="divAdd" v-else>
                  <img src="@/images/front/add.png" @click.prevent.stop="addCart(item)"/>
                </div>
              </div>
            </div>
          </div>
    ...
    <van-dialog v-model="dialogFlavor.show" :show-confirm-button="false" class="dialogFlavor" ref="flavorDialog">
      ...
      <div class="divFlavorClose" @click="dialogFlavor.show = false">
        <img src="@/images/front/close.png"/>
      </div>
    </van-dialog>
        ...
        <div v-for="item in cartData" :key="item.id" class="divCartItem">
          ...
          <div class="divNum">
            <div class="divSubtract">
              <img src="@/images/front/subtract.png" @click="cartNumberSubtract(item)"/>
            </div>
            <div class="divDishNum">{{item.number}}</div>
            <div class="divAdd">
              <img src="@/images/front/add.png" @click="cartNumAdd(item)"/>
            </div>
          </div>
      ...
      <div class="divNum">
        ...
        <div class="right">
          <div class="divSubtract" v-if="detailsDialog.item.number > 0">
            <img src="@/images/front/subtract.png" @click="subtractCart(detailsDialog.item)"/>
          </div>
          ...
          <div class="divAdd" v-else>
            <img src="@/images/front/add.png" @click="addCart(detailsDialog.item)"/>
          </div>
        </div>
      </div>
    ...
    >
      <div class="divContainer">
        ...
        <div class="item" v-for="(item,index) in setMealDialog.item.list.setmealDishes" :key="index">
          <el-image :src="imgPathConvert(item.image)">
<!--          <el-image :src="imgPathConvert('0f252364-a561-4e8d-8065-9a6797a6b1d3.jpg')">-->
            <div slot="error" class="image-slot">
              <img src="@/images/front/noImg.png"/>
            </div>
          </el-image>
      ...
      <div class="divNum">
        ...
        <div class="right">
          <div class="divSubtract" v-if="setMealDialog.item.number > 0">
            <img src="@/images/front/subtract.png" @click="subtractCart(setMealDialog.item)"/>
          </div>
          <div class="divDishNum">{{setMealDialog.item.number}}</div>
          <div class="divAdd" v-if="setMealDialog.item.number">
            <img src="@/images/front/add.png" @click="addCart(setMealDialog.item)"/>
          </div>
    ...
    async dishDetails(item){
      ...
      if(Array.isArray(item.flavors)){
        ...
        if(res.code === 1){
          ...
          console.log(JSON.stringify(this.setMealDialog.item.list))
...
/*  src: url("ttf/PingFangSC-Regular.ttf");*/
/*  font-weight: normal;*/
/*  font-style: normal;*/
/*}*/
...
/*  src: url("ttf/PingFangSC-Semibold.ttf");*/
/*  font-weight: normal;*/
/*  font-style: normal;*/
/*}*/
